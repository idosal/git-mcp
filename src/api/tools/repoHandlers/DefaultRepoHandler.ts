...
class DefaultRepoHandler implements RepoHandler {
  ...
  getTools(repoData: RepoData, env: any, ctx: any): Array<Tool> {
    ...
    return [
      ...
      // {
      //   name: "fetch_code_usage_examples",
      //   description:
      //     "Fetch code examples from the repository that use the given function. Only use this if no other examples are found.",
      //   paramsSchema: {
      //     functionName: z
      //       .string()
      ...
      //       }
      //     } catch (error) {
      //       console.error("Error in fetch_code_usage_examples:", error);
      //       return {
      //         content: [
      //           {
      //             type: "text",
